...
export default function LeadForm({
  ...
  const formStyle = isSunset ? { background: "rgba(255,255,255,0.12)", borderColor: "rgba(255,255,255,0.25)" } : undefined;
  const inputCls = isSunset
  ...
  const buttonStyle = isSunset
    ? { background: "linear-gradient(135deg, #8E44AD 0%, #FF8C42 100%)", boxShadow: "0 10px 30px rgba(255,140,66,0.5)" }
    : undefined;
  const accentColor = isSunset ? "accent-orange-500" : "accent-red-600";
  const errCls = isSunset
  ...
  if (status.kind === "success") {
    ...
    return (
      <div className={isSunset
        ...
        style={isSunset ? { background: "rgba(255,255,255,0.18)", borderColor: "rgba(255,255,255,0.35)" } : undefined}>
